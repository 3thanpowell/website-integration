    ...
    <div class="row row-cols-2 row-cols-md-4 m-3">
      ...
      <div class="col">
        <div class="p-3 m-3 d-flex">
          <svg class="" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="none" viewBox="0 0 24 24" style="min-width:42px !important; min-height:42px !important;">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
          </svg> 
          <p class="ml-2 text-dark">SAME HOUR SHIPPING</p>
        </div>
      </div>
      ...
      <div class="col">
        ...
        <p class="ml-2 text-dark">9 YEAR WARRANTY</p>
        </div>
      </div>
      ...
      <div class="col">
        <div class="p-3 m-3 d-flex">
          <svg class="bi" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="none" viewBox="0 0 24 24" style="min-width:42px !important; min-height:42px !important;">
          ...
          <p class="ml-2 text-dark">FREE YOGHURT OVER $200*</p>
        </div>
      </div>
      ...
      <div class="col">
        <div class="p-3 m-3 d-flex">
         <svg class="" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="none" viewBox="0 0 24 24" style="min-width:42px !important; min-height:42px !important;">
            <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m6 6 12 12m3-6a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
          </svg>
          <p class="ml-2 text-dark">NO SHIPPING INSURANCE</p>
        </div>
      </div>
    </div>
  </div>
