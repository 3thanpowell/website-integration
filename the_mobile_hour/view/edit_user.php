...
<body>
  ...
  <header>
    ...
    <div class="container mt-5">
      <h1 class="display-4">Edit User Information</h1>
    </div>
  ...
  <main>
    <div class="container mt-5 p-5 border border-secondary rounded">
      ...
      <!-- critical actions (delete, promote, demote) -->
        ...
        <div class="card">
          ...
          <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#dangerOptions">
            <div class="card-body">
              ...
              <!-- send password reset link - does nothing -->
    ...
    <div class="modal fade" id="confirmDeleteModal" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            <a href="../controller/delete_user.php?id=<?php echo htmlentities($user['user_id']); ?>" class="btn btn-danger">Delete</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="confirmPromoteModal" tabindex="-1" role="dialog" aria-labelledby="confirmPromoteModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            <a href="../controller/promote_user.php?id=<?php echo htmlspecialchars($user['user_id']); ?>" class="btn btn-info">Promote</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="confirmDemoteModal" tabindex="-1" role="dialog" aria-labelledby="confirmDemoteModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            <a href="../controller/demote_user.php?id=<?php echo htmlspecialchars($user['user_id']); ?>" class="btn btn-warning">Demote</a>
          </div>
        </div>
      </div>
    </div>
